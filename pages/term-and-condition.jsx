function TermAndCondition() {
  ...
  return (
    <main>
      ...
      <p>Welcome to Weddingnesia!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Weddingnesia{`'`}s Website, located at weddingnesia.id.
      </p>
      ...
      <p>
        ...
        Weddingnesia for your own personal use subjected to restrictions set in
      ...
      <p>
        ...
        Weddingnesia does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Weddingnesia,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Weddingnesia shall not be
      ...
      <p>
        You hereby grant Weddingnesia a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Weddingnesia; and (d) the link
      ...
      <p>
        ...
        e-mail to Weddingnesia. Please include your name, your organization
