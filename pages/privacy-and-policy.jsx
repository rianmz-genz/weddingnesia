    ...
    <maiin>
      ...
      <p>
        ...
        <a href="https://www.privacypolicyonline.com/what-are-cookies/">
          the `&quot`Cookies`&quot` article from the Privacy Policy Generator
        </a>
        .
      </p>
      ...
      <p>
        ...
        advertising partners of Weddingnesia.
      </p>

      <p>{cookieDescription2}</p>
      ...
      <p>{thirdPartyDescription}</p>

      <p>{thirdPartyDescription2}</p>
      ...
      <p>
        ...
        shared and/or collect in Weddingnesia. This policy is not applicable to
