...
export const initialValue = {
  ...
  home: {
    ...
    hero: {
      ...
      description:
        "Undang orang-orang terdekat dalam momen kebahagiaan pernikahan Anda dengan cara yang unik dan menarik. Coba buat undangan pernikahan online gratis sekarang juga!",
      img: "/images/heroimg.png",
    },
    interest: {
      title: "Website Undangan Gratis Terbaik Di Indonesia",
      description:
        "WeddingNesia adalah platform untuk pembuatan undangan pernikahan online gratis terbaik sejak 2023.",
      ...
      items: [
        {
          ...
          title: "Smart System",
          description:
            "WeddingNesia memiliki sistem yang mudah digunakan dan mendukung kustomisasi yang sangat fleksibel. Anda bisa mengatur undangan sesuai keinginan dan keperluan.",
        },
        {
        ...
        },
        {
          ...
          description:
            "Tidak perlu menunggu lama, selesaikan masalah Anda dengan cepat secara real time melalui live chat whatsapp bersama tim support kami.",
        },
        {
    ...
    tutorial: {
      ...
      description:
        "Cukup lakukan 4 langkah untuk buat website undangan digital sendiri. Untuk lebih jelasnya silakan ikuti petunjuk di bawah ini",
      ...
      items: [
        ...
        },
        {
          ...
          title: "Isi Informasi",
          description:
            "Isi seluruh informasi seperti waktu, lokasi, foto & video dan daftarkan tamu undangan Anda.",
        },
        {
        ...
        },
        {
          ...
          title: "Pantau",
          description:
            "Lihat statistik tamu yang hadir dan baca ucapan doa dari tamu yang telah di undang.",
        },
      ],
    },
    feature: {
      title: "Fitur Terbaik",
      description:
        "Berbagai macam fitur terbaik undangan online yang Anda butuhkan ada disini dan kami akan selalu berinovasi menambahkan fitur-fitur lainnya.",
      items: [
        {
          icon: <CiGlobe />,
        ...
        },
        {
          ...
          description:
            "Menggunakan dashboard dengan tampilan dan cara penggunaan yang mudah dimengerti",
        },
        {
        ...
        },
        {
          ...
          title: "Tema Instan",
          description:
            "Tersedia satu macam tema siap pakai yang dapat diganti kapan saja tanpa batas",
        },
        {
          icon: <FaPeopleGroup />,
          title: "Manajemen Tamu",
          description:
            "Fitur pengaturan tamu baik personal / grup sesuai preferensi (undangan / informasi)",
        },
        {
        ...
        },
        {
          ...
          title: "Story & Quotes",
          description:
            "Ceritakan perjalanan / deskripsi undangan Anda & tambahkan quotes kepada tamu undangan",
        },
        {
          icon: <AiFillGift />,
          title: "Hadiah",
    ...
    testimonials: {
      title: "Testimoni",
      description:
        "Bukti nyata bahwa datengdong telah menjadi bagian kebahagiaan momen terbaik mereka.",
      button: {
      ...
      items: [
        {
          ...
          job: "Karyawan Swasta",
          comment:
            "Baru kali ini ada platform undangan online pernikahan yang gratis dan simple. Terimakasih WeddingNesia.",
        },
        {
          ...
          job: "Wirausahawan",
          comment:
            "Sangat mudah digunakan, undangan pernikahan langsung bisa dibagikan dengan cepat! Sukses WeddingNesia.",
        },
        {
