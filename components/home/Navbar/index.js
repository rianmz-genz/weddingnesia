      ...
      <nav className="w-full mx-auto flex lg:flex-row flex-col justify-between lg:items-center ">
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="text-2xl bg-slate-100 p-2 rounded lg:hidden "
          >
            {isOpen ? <FiX /> : <HiOutlineBars3BottomRight />}
          </button>
        </div>
        <ul
          className={`lg:flex lg:flex-row flex-col w-full lg:justify-evenly justify-center items-center bg-white max-lg:shadow px-8 py-8 lg:px-0 lg:py-0 space-y-3 lg:space-y-0 ${
            isOpen ? "" : "hidden"
          }`}
        >
